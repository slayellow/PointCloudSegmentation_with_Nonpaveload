...
paths = dict(
        ...
        log_save_path = "/home/HONG/Semantic-KITTI/Changwon_Nonpaveload/dataset/sequences/98/velodyne",
        changwon_save_path = "/home/HONG/Semantic-KITTI/Changwon_Nonpaveload/dataset/sequences/98/label"
)
