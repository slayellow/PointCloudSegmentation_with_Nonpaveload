...
from inference.LaserScan import LaserScan, SemLaserScan
...
def get_inference_data(model_info, xyz, intensity):
    ...
    return torch.unsqueeze(proj, 0), torch.unsqueeze(proj_x, 0), torch.unsqueeze(proj_y, 0), \
           torch.unsqueeze(proj_range, 0), torch.unsqueeze(unproj_range, 0),  num_points
